Here is my interpretation of Conway's Game of Life written in Ruby.
...
To start the game from a terminal prompt just run from within lib: `ruby start_game.rb`
...
Tests can be found in the spec folder and they can be run form within the spec folder like so: `rspec .`
